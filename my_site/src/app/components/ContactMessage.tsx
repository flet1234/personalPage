  ...
  async function submitText(formData: FormData) {
    ...
    return (
        <form action={submitText} className="flex flex-col gap-2">
            ...
            <textarea rows={4} cols={1} placeholder="Max message length is 500" id="message" maxLength={500} name="message" className="text-textColor bg-background rounded resize-y p-2"/>
